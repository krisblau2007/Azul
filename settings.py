...
# PlayState at runtime. The window itself is always sized for
# MAX_PLAYERS so starting a game never needs to resize it.
MAX_PLAYERS = 4
...
# Screen size is computed for MAX_PLAYERS, not whatever gets picked at
# the menu — that's what lets the window stay a fixed size regardless
# of the player count chosen for a given game.
